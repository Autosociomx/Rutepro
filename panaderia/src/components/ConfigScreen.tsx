        ...
        <div className="flex-1 p-5 space-y-6">
          ...
          {isNew && (
            ...
            {aiMode === 'descripcion' ? (
              ...
              <div className="space-y-3.5">
                <p className="text-[10px] text-purple-200/70 leading-relaxed text-left">
                  ¡Haz demostraciones de impacto! Pega la web de tu cliente prospecto (ej: <span className="text-purple-300 font-semibold">panaderiaeltrigo.com</span>) y Gemini buscará sus datos reales, catálogo estrella, precios locales y gama de marca para estructurar su app personalizada.
                </p>
                <div className="flex gap-2 bg-[#0B0E14] border border-purple-500/10 rounded-lg p-1.5">
                  <input 
                    type="text" 
                    ...
                    disabled={aiGenerating}
                    className="flex-1 bg-transparent p-1 px-1.5 text-xs focus:outline-none placeholder-purple-300/30 text-white disabled:opacity-50"
                    placeholder="Ej: panaderiaeltrigo.com"
                  />
                  <button 
                    type="button"
            ...
            <div className="grid grid-cols-2 gap-4">
              ...
              <div className="flex flex-col gap-1.5 text-left">
                ...
                <input 
                  ...
                  className="bg-[#181D2B] border border-white/5 rounded-lg px-3.5 py-2.5 text-xs text-white focus:outline-none focus:border-amber-500"
                  placeholder="Ej: El pan más fresco de la colonia"
                />
              </div>
            </div>
